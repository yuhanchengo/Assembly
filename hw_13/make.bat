...
del lab13.lst	REM lab13可以替換成.asm檔的檔名
del lab13.obj
del lab13.ilk
del lab13.pdb
del lab13.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:lab13.exe lab13.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
